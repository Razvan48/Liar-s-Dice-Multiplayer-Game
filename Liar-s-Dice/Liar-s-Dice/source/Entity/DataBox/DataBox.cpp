...
DataBox::DataBox(float centerPosX, float centerPosY, float width, float height, float rotateAngle, const std::string& text, const std::string& textureName, const std::string& initialText)
